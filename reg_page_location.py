        ...
        while True:
            ...
            try:    
                data = {
                    ...
                    'place_topics': '["2700"]',
                    'store_name': (json.load(requests.get('https://story-shack-cdn-v2.glitch.me/generators/vietnamese-name-generator/').text)['data']['female'])+' '+datetime.date.today()).strftime("%d/%m/%Y")+str((datetime.datetime.now())),
                    'store_number': a,
                }
